...
(function (G2A) {
  "use strict";
  const G2A_THEME_ICON_SUN = '<svg class="g2a-ico" viewBox="0 0 24 24" width="18" height="18" aria-hidden="true" focusable="false" fill="none" stroke="currentColor" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="4"/><path d="M12 2v2"/><path d="M12 20v2"/><path d="m4.93 4.93 1.41 1.41"/><path d="m17.66 17.66 1.41 1.41"/><path d="M2 12h2"/><path d="M20 12h2"/><path d="m6.34 17.66-1.41 1.41"/><path d="m19.07 4.93-1.41 1.41"/></svg>';
  const G2A_THEME_ICON_MOON = '<svg class="g2a-ico" viewBox="0 0 24 24" width="18" height="18" aria-hidden="true" focusable="false" fill="none" stroke="currentColor" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round"><path d="M21 12.79A9 9 0 1 1 11.21 3 7 7 0 0 0 21 12.79z"/></svg>';
  ...
  function applyTheme(theme) {
    ...
    document.querySelectorAll("[data-theme-toggle]").forEach((btn) => {
      ...
      if (ico) ico.innerHTML = light ? G2A_THEME_ICON_MOON : G2A_THEME_ICON_SUN;
