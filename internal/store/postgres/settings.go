...
func (c *Connector) PublicSettings(ctx context.Context) (map[string]any, error) {
	...
	out := map[string]any{
		...
		"auto_replenish_enabled":        boolSetting(values, "auto_replenish_enabled", false),
		"auto_replenish_min_accounts":   intSetting(values, "auto_replenish_min_accounts", 50),
		"auto_replenish_count":          intSetting(values, "auto_replenish_count", 5),
		"auto_replenish_interval_sec":   floatSetting(values, "auto_replenish_interval_sec", 120),
...
func (c *Connector) UpdateRuntimeSettings(ctx context.Context, patch map[string]any) (map[string]any, error) {
	...
	specs := []fieldSpec{
		...
		{key: "auto_replenish_enabled", kind: "bool"},
		{key: "auto_replenish_min_accounts", kind: "int", minF: 0, maxF: 100_000},
		{key: "auto_replenish_count", kind: "int", minF: 1, maxF: 10_000},
		{key: "auto_replenish_interval_sec", kind: "float", minF: 30, maxF: 86400},
